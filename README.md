...
7. Navigate back to the organization's **Repositories** tab and create a new repository named `public-repo` with the visibility option set to `public` and the `Add a README file` box **checked**
